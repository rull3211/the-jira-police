...
this tree and is unreadable from inside it (`PLAN.md` §12). Assume neither is watched. Neither is
any less binding for that; the only difference is that breaking one may not be caught.
