...
**third instance in one session** of a check that did not cover what it claimed; the other two ship
with PR #22 and are not on this branch. The candidate amendment — _state which case your check does
not cover before quoting it as evidence_ — reached its threshold here and is **proposed, not
written**: see `claude-validation-work`, "The rule this work owes".
